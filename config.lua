...
Config.DistanceEarnings = true -- If true the Eearnings will be multiplied X distance. For example if distance is 1500 the price will be "Config.Earnings * 1.5" (If the distance is below 1000 it will be always "Config.Earnings * 1.0".
